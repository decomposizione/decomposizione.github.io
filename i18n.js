...
const translations = {
    en: {
        ...
        graphTidalSNRLabel: "M2 & S2 Signal-to-Noise Ratio Over Time",
    ...
    it: {
        ...
        graphTidalSNRLabel: "Rapporto Segnale/Rumore M2 & S2 nel Tempo",
...
function applyTranslations() {
    ...
    document.getElementById('graph-tidal-snr-label').textContent = t.graphTidalSNRLabel;
